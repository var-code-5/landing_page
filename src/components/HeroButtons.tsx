    ...
    <>
      ...
      <div className="relative z-10 py-3 flex items-end hidden lg:flex">
        <button
          ...
          type="button"
          className="relative overflow-hidden font-montserrat h-fit font-semibold text-sm md:text-lg px-1 md:px-6 py-1 md:py-2 bg-[#FF6600] text-white rounded-full hover:bg-primary transition-all flex flex-row justify-between pl-3 md:pl-4 gap-x-2 md:gap-x-3 pr-2 md:pr-3 items-center group shadow-lg hover:shadow-xl hover:scale-105 duration-500 ease-out"
        >
          <span className="relative z-10 md:px-2">JOIN OUR WAITLIST</span>
