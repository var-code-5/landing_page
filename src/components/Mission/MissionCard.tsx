...
function MissionCard({
  ...
  return (
    <div id="mission" className="mt-6 sm:mt-8 md:mt-12 w-full md:w-2/5 bg-background md:bg-white text-white md:text-black p-4 sm:p-6 md:p-8 md:hover:bg-background md:hover:text-white rounded-xl sm:rounded-2xl md:rounded-3xl transition-all duration-300 group overflow-hidden h-full">
