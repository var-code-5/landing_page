  ...
  return (
    <div id="mission" className="mt-6 sm:mt-8 md:mt-12 w-full md:w-2/5 bg-background md:bg-white text-white md:text-black p-4 sm:p-6 md:p-8 md:hover:bg-background md:hover:text-white rounded-xl sm:rounded-2xl md:rounded-3xl transition-all duration-1000 group overflow-hidden h-full">
      <div className="flex flex-col md:flex-row md:group-hover:flex-col items-start md:items-center md:group-hover:items-start mb-2 sm:mb-3 md:mb-4 justify-start gap-2 sm:gap-3 md:gap-4 w-full">
        ...
        />
        <p className="font-borela text-3xl sm:text-4xl md:text-5xl text-white md:text-background md:group-hover:text-white transition-colors duration-1000">{title}</p>
      </div>
      <div className="flex flex-col h-full">
        <p className="font-montserrat text-base sm:text-xl md:text-2xl mb-6 sm:mb-8 md:mb-12 opacity-100 max-h-screen md:opacity-0 md:max-h-0 md:group-hover:opacity-100 md:group-hover:max-h-screen transition-all duration-1000 ease-in-out">
          {description}
        </p>
