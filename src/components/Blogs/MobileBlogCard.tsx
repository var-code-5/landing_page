...
const MobileBlogCard: React.FC<MobileBlogCardProps> = ({ image, title, description }) => {
  return (
      ...
      <div className="p-4 font-montserrat text-left">
        ...
        <div className="relative">
              ...
              >
                ...
                <MoveUpRight color='white' className='w-6 text-background h-6 bg-[#A05514] rounded-full p-1' />
              </button>
            </div>
      </div>
    </div>
